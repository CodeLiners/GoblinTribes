package lyneira.goblintribes.common.entity;
...
/**
 * The generic Goblin entity, it's really just a cow right now.
 * 
 * @author max96at
 */


public class EntityGenericGoblin extends EntityAnimal {

	public EntityGenericGoblin(World par1World) {
		super(par1World);
		this.texture = CommonProxy.TEXTUR_DIR + "genericGoblin.png";
		this.setSize(0.2F, 0.83F);
	 ...
	 */
	public EntityGenericGoblin spawnBabyAnimal(EntityAgeable par1EntityAgeable) {
		return new EntityGenericGoblin(this.worldObj);
	}
